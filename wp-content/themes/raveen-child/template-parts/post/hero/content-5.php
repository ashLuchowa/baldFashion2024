...
$post_layout_meta = rivax_get_option('single-layout-5-meta');
if($post_layout_meta) {
    $meta_args = array(
...
<div class="single-hero-layout-5">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="single-hero-layout-5-container" style="background-image: url(<?php echo esc_url(get_the_post_thumbnail_url(NULL, 'rivax-large-wide')); ?>);">
